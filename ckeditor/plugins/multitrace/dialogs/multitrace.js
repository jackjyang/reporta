CKEDITOR.dialog.add( 'multitraceDialog', function( editor ) {
    return {
        title: 'Multi Trace Analytic Properties',
        minWidth: 400,
        minHeight: 200,
        contents: [
            {
                ...
                elements: [
                    ...
                    },
                    {
                        ...
                        items: [ [ '' ], [ 'Five Number Summary' ], [ 'Parallel Coordinates' ] ],
                        'default': '',
        ...
        onOk: function() {
            ...
            chart.setAttribute('src', '/ckeditor/plugins/multitrace/icons/placeholder.jpg');
            chart.setAttribute('style', 'width: 50px; height: 33px;');
            chart.setAttribute('name', dialog.getValueOf( 'tab-basic', 'name'));
            chart.setAttribute('type', 'multitrace');
