CKEDITOR.dialog.add( 'invariantDialog', function( editor ) {
    return {
        title: 'Invariant Mining Properties',
        minWidth: 400,
        minHeight: 200,
        contents: [
            {
                ...
                elements: [
                    ...
                    },
                    {
                        type: 'select',
                        id: 'type',
                        label: 'Type of Invariant Mining',
                        items: [ [ '' ], [ 'Co-occurence' ], [ 'Followed By' ], [ 'Preceded By' ],
                            [ 'IFF Co-occurence' ], [ 'Single Period' ], [ 'Dependencies' ] ],
                        'default': '',
                        validate: CKEDITOR.dialog.validate.notEmpty( "Invariant Mining type cannot be empty." ),
                        setup: function( element ) {
        ...
        onOk: function() {
            ...
            chart.setAttribute('src', '/ckeditor/plugins/invariant/icons/placeholder.jpg');
            chart.setAttribute('style', 'width: 50px; height: 33px;');
            chart.setAttribute('name', dialog.getValueOf( 'tab-basic', 'name'));
            chart.setAttribute('type', 'invariant');
