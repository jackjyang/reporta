CKEDITOR.dialog.add( 'eventRuntimeJitterDialog', function( editor ) {
    return {
        title: 'Event and Runtime Jitter Properties',
        minWidth: 400,
        minHeight: 200,
        contents: [
            {
        ...
        onOk: function() {
            ...
            chart.setAttribute('data-analytictype', 'eventRuntimeJitter');
