CKEDITOR.dialog.add( 'parallelCoordinateDialog', function( editor ) {
    return {
        title: 'Parallel Coordinate Properties',
        minWidth: 400,
        minHeight: 200,
        contents: [
            {
        ...
        onOk: function() {
            ...
            chart.setAttribute('data-analytictype', 'parallelCoordinate');
