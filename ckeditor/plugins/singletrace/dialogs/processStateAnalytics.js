CKEDITOR.dialog.add('processStateAnalyticsDialog', function(editor) {
  return {
    title: 'Process State Analytics Properties',
    minWidth: 400,
    minHeight: 200,
    contents: [{
      id: 'tab-basic',
    ...
    onOk: function() {
      ...
      chart.setAttribute('data-type', 'processStateAnalytics');
