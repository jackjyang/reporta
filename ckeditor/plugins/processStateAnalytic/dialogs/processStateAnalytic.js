CKEDITOR.dialog.add( 'processStateAnalyticDialog', function( editor ) {
    return {
        title: 'Process State Analytic Properties',
        minWidth: 400,
        minHeight: 200,
        contents: [
            {
        ...
        onOk: function() {
            ...
            chart.setAttribute('data-analytictype', 'processStateAnalytic');
